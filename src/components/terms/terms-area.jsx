...
const terms_conditions_content = {
    ...
    des: <>This Terms of Service (the “Terms”) describes the rights and responsibilities
            ...
            “Service”), each owned and operated by MarketXpose Holdings Ltd. (“MarketXpose”, “we”, “our” or
            “us”).<br />
            Please read the Terms carefully before using the Service. If you don’t agree to the Terms, as
            well as Dribbble’s Privacy Policy (the “Privacy Policy”) and MarketXpose’s
    ...
    terms_list : [
        {
            id: "01",
            text: <>Your MarketXpose Account. If you create an account on the Service (your “Account”), you are
                ...
                of others, and MarketXpose may change or remove any description or keyword that it considers
                inappropriate or unlawful, or otherwise likely to cause MarketXpose
                liability. You must immediately notify MarketXpose of any unauthorized uses of your Account or
                any
                other breaches of security. MarketXpose will not be liable for
        ...
        },
        {
            ...
            text: <>Fees and Renewals. Pricing for Paid Accounts will be provided at the time of purchase.
                    ...
                    by MarketXpose, fees for a Paid Account will be billed in advance for each year and are
